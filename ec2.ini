...
# To exclude VPC subnets from the inventory, uncomment and set to False.
#vpc_subnets = False
...
# Add variables 'ansible_host' and 'ansible_ssh_host' to hostvars.
add_var_ansible_host = False
